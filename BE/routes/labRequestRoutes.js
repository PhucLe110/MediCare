...
const { createLabRequest, getPendingRequests, getAllRequests, startRequest, completeRequest } = require('../controllers/labRequestController');
...
router.post('/:id/complete', protect, upload.single('file'), completeRequest);
