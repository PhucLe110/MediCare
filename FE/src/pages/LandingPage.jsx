...
const trans = {
  vi: {
    ...
    servicesDesc:
      "Chúng tôi cung cấp các dịch vụ chăm sóc sức khỏe toàn diện với đội ngũ chuyên gia hàng đầu và trang thiết bị hiện đại nhất.",
    service1Name: "Khoa Nội tổng quát",
    service1Desc:
      "Điều trị nội khoa toàn diện các bệnh tim mạch, tiêu hóa, hô hấp, nội tiết và thần kinh.",
    service2Name: "Khoa Ngoại tổng quát",
    service2Desc:
      "Phẫu thuật ngoại khoa kỹ thuật cao và xâm lấn tối thiểu với tính an toàn vượt trội.",
    service3Name: "Khoa Nhi",
    service3Desc:
      "Chăm sóc y khoa toàn diện cho trẻ sơ sinh và trẻ nhỏ, tư vấn dinh dưỡng nâng cao.",
    service4Name: "Khoa Sản",
    service4Desc:
      "Dịch vụ thai sản trọn gói, đồng hành cùng mẹ bầu đón bé yêu chào đời bình an.",
    service5Name: "Khoa Tim mạch",
    service5Desc:
      "Tầm soát chuyên sâu bệnh mạch vành, van tim và can thiệp tim mạch hiện đại.",
    service6Name: "Khoa Chấn thương chỉnh hình",
    service6Desc:
      "Phẫu thuật thay khớp, cột sống, can thiệp chấn thương thể thao và phục hồi.",
    service7Name: "Khoa Tai Mũi Họng",
    service7Desc:
      "Khám chữa chuyên sâu viêm xoang, thanh quản và các bệnh lý vùng họng tai.",
    service8Name: "Khoa Da liễu",
    service8Desc:
      "Điều trị bệnh ngoài da kết hợp laser công nghệ cao phục hồi thẩm mỹ tối ưu.",
    service9Name: "Khoa Mắt",
    service9Desc:
      "Đo khúc xạ kỹ thuật số và phẫu thuật đục thủy tinh thể bằng công nghệ Phaco.",
    learnMore: "Tìm hiểu thêm",
    doctorsSubtitle: "Đội ngũ Bác sĩ",
    doctorsTitle: "Chuyên gia y tế hàng đầu",
    doctorsDesc:
      "Đội ngũ y bác sĩ giàu kinh nghiệm, tận tâm vì sức khỏe của bạn và gia đình.",
    ...
    processDesc:
      "Trải nghiệm dịch vụ y tế không chờ đợi, số hóa toàn bộ thủ tục để tối ưu thời gian cho bệnh nhân.",
    step1Title: "AI Tư vấn sơ bộ",
    step1Desc:
      "Nhập triệu chứng, AI sẽ gợi ý chuyên khoa và bác sĩ phù hợp nhất.",
    step2Title: "Đặt lịch trực tuyến",
    step2Desc:
      "Chọn giờ khám, thanh toán nhanh chóng mà không cần xếp hàng lấy số.",
    step3Title: "Đến khám trực tiếp",
    step3Desc:
      "Bác sĩ kiểm tra chuyên sâu dựa trên các thông tin đã được AI phân tích.",
    step4Title: "Nhận kết quả Online",
    step4Desc:
      "Đơn thuốc và bệnh án được lưu trữ điện tử, theo dõi dễ dàng qua app.",
  },
  en: {
    heroTitle1: "Healthcare Services",
    heroTitle2: "Comprehensive & Smart",
    heroDesc:
      "MediCare leverages state-of-the-art AI technology to help you schedule appropriate physicians, departments, and medical appointments.",
    ...
    aboutDesc:
      "MediCare proudly stands as a pioneer integrating advanced Artificial Intelligence into clinical pathways. We offer an entirely digital healthcare ecosystem spanning symptom analysis, clinical queues, and lifelong medical record indexing.",
    ...
    servicesDesc:
      "We offer specialized clinical care and comprehensive treatment pathways facilitated by stellar medical specialists and advanced gear.",
    service1Name: "General Internal Medicine",
    service1Desc:
      "Comprehensive medical treatment of cardiovascular, digestive, endocrinological, and neurological systems.",
    service2Name: "General Surgery Department",
    service2Desc:
      "State-of-the-art surgical interventions with micro-invasive techniques for superior patient safety.",
    service3Name: "Pediatric Care Unit",
    service3Desc:
      "Full-spectrum healthcare from neonatology to child growth monitoring and nutritional guidance.",
    service4Name: "Obstetrics & Gynecology",
    service4Desc:
      "All-inclusive maternal wellness paths and supportive birth plans for the safest delivery experience.",
    service5Name: "Cardiovascular Care",
    service5Desc:
      "Comprehensive coronary screenings, heart-valve evaluation, and modern interventional cardiology.",
    service6Name: "Orthopedics & Joint Care",
    service6Desc:
      "Expert joint replacements, spinal surgeries, sports injury interventions, and custom rehab plans.",
    service7Name: "Otolaryngology (ENT)",
    service7Desc:
      "Highly specialized treatment of chronic sinusitis, vocal cord disorders, and middle ear diseases.",
    service8Name: "Dermatology & Skin Care",
    service8Desc:
      "Advanced medical dermatology combined with state-of-the-art laser cosmetic therapies.",
    service9Name: "Ophthalmology Unit",
    service9Desc:
      "Digital refractive diagnostic mapping and premium Phaco cataract replacement surgery.",
    learnMore: "Learn More",
    doctorsSubtitle: "Medical Experts",
    doctorsTitle: "Eminent Attending Physicians",
    doctorsDesc:
      "Highly experienced, dedicated medical experts focused entirely on your wellness.",
    ...
    processDesc:
      "Enjoy clinical care without waiting queues, with completely paperless digital logistics maximizing your time.",
    step1Title: "AI Symptom Screening",
    step1Desc:
      "Enter symptoms and receive instant triage recommendations for specialist clinics.",
    step2Title: "Secure Slot Booking",
    step2Desc:
      "Choose preferred slot and settle medical fees securely without queuing.",
    step3Title: "In-Clinic Assessment",
    step3Desc:
      "Eminent doctor conducts targeted assessment supported by preliminary AI triage logs.",
    step4Title: "Digital Results Release",
    step4Desc:
      "Review secure clinical transcripts, diagnostics, and prescriptions on the client portal.",
  },
};
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="w-full max-w-md space-y-4">
                {[
                  ...
                  {
                    icon: FolderHeart,
                    title: t.actionRecordTitle,
                    desc: t.actionRecordDesc,
                    primary: false,
                  },
                  {
                    icon: CreditCard,
                    title: t.actionPayTitle,
                    desc: t.actionPayDesc,
                    primary: false,
                  },
                ].map((item, index) => (
                  <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                img: "https://images.unsplash.com/photo-1551076805-e1869033e561?w=500&q=80",
                name: t.service2Name,
                desc: t.service2Desc,
              },
              {
              ...
              {
                img: "https://images.unsplash.com/photo-1531983412531-1f49a365ffed?w=500&q=80",
                name: t.service4Name,
                desc: t.service4Desc,
              },
              {
