    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-[var(--text-secondary)] mt-2">{t.sub}</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-[var(--card-bg)] rounded-3xl p-12 text-center border border-[var(--border-color)] shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-4">
            <h3 className="text-sm font-bold text-[var(--text-tertiary)] uppercase tracking-wider px-2">
              {t.listTitle}
            </h3>
          ...
          <div className="lg:col-span-8">
            {selectedPrescription && (
              <div className="bg-[var(--card-bg)] rounded-3xl shadow-sm border border-[var(--border-color)] overflow-hidden animate-in fade-in slide-in-from-right-4 duration-300">
                {/* Detail Header */}
                ...
                <div className="p-8">
                  {/* Doctor & Diagnosis */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 pb-10 border-b border-[var(--border-color)]">
                    <div className="space-y-4">
                      <h4 className="text-xs font-bold text-[var(--text-tertiary)] uppercase tracking-wider flex items-center gap-2">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-[var(--bg-tertiary)] rounded-2xl border border-[var(--border-color)]">
                  ...
                  {/* Medicines Table */}
                  <div className="mb-10">
                    <h4 className="text-xs font-bold text-[var(--text-tertiary)] uppercase tracking-wider mb-4 flex items-center gap-2">
                    ...
                    <div className="overflow-x-auto rounded-2xl border border-[var(--border-color)]">
                      <table className="w-full text-left">
                        <thead className="bg-[var(--bg-tertiary)]">
                          <tr>
                            <th className="px-6 py-4 text-xs font-bold text-[var(--text-secondary)] uppercase">
                              {t.medName}
                            </th>
                            <th className="px-6 py-4 text-xs font-bold text-[var(--text-secondary)] uppercase">
                              {t.quantity}
                  ...
                  {selectedPrescription.doctorNotes && (
                    <div className="bg-yellow-50/50 dark:bg-yellow-900/20 rounded-2xl p-6 border border-yellow-100 dark:border-yellow-900/30 mb-8">
                      <h4 className="text-sm font-bold text-yellow-700 dark:text-yellow-500 mb-2 flex items-center gap-2">
                  ...
                  {/* Footer Stats */}
                  <div className="flex justify-end p-6 bg-[var(--bg-tertiary)] rounded-2xl border border-[var(--border-color)]">
