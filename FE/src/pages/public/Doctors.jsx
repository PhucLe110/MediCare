  ...
  return (
    <div className="bg-white min-h-screen pt-24 pb-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-8 relative">
          ...
          <div className="flex gap-4 relative">
            ...
            <button 
              ...
              className={`px-6 py-4 rounded-2xl transition-colors flex items-center justify-center ${showFilter ? 'bg-[#102A63] text-white shadow-lg' : 'bg-gray-50 text-gray-500 hover:bg-gray-100'}`}
            >
              <Filter size={20} />
            </button>
            ...
            {Object.keys(filteredGrouped).length === 0 ? (
              ...
              Object.entries(filteredGrouped).map(([department, deptDoctors], deptIndex) => (
                <div key={deptIndex} className="mb-12">
                  <h3 className="text-2xl font-black text-[#102A63] mb-8 pb-4 border-b-2 border-gray-100 flex items-center gap-3">
        ...
        <div className="mt-32 bg-[#102A63] rounded-[3rem] p-12 lg:p-20 text-white relative overflow-hidden">
