  ...
  return (
    <div className="space-y-6 relative">
      ...
      <div className="flex justify-between items-center bg-[var(--card-bg)] p-6 rounded-3xl border border-[var(--border-color)] shadow-sm animate-in fade-in">
        ...
        <div className="flex bg-[var(--bg-tertiary)] p-1 rounded-xl mx-4">
          <button
            onClick={() => setActiveTab("doctors")}
            className={`px-4 py-2 text-sm font-bold rounded-lg transition-all ${activeTab === "doctors" ? "bg-[var(--card-bg)] text-indigo-600 dark:text-indigo-400 shadow-sm" : "text-[var(--text-secondary)] hover:text-[var(--text-primary)]"}`}
          >
            Danh sách Bác sĩ
          </button>
          <button
            onClick={() => setActiveTab("shifts")}
            className={`px-4 py-2 text-sm font-bold rounded-lg transition-all ${activeTab === "shifts" ? "bg-[var(--card-bg)] text-indigo-600 dark:text-indigo-400 shadow-sm" : "text-[var(--text-secondary)] hover:text-[var(--text-primary)]"}`}
          >
            Yêu cầu ca trực
          </button>
        </div>
      ...
      {activeTab === "shifts" ? (
        ...
        <div className="bg-[var(--card-bg)] rounded-3xl border border-[var(--border-color)] shadow-sm overflow-hidden animate-in fade-in">
          <div className="p-4 border-b border-[var(--border-color)] flex items-center bg-[var(--bg-tertiary)]">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-[var(--card-bg)] border border-[var(--border-color)] rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 w-80 text-[var(--text-primary)]"
              />
            </div>
          </div>
                  ...
                  >
                    ...
                    <td className="p-4 pr-6 text-right space-x-2">
                      <button
                        ...
                        className="p-2 text-[var(--text-tertiary)] hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-lg transition-colors"
                      >
                        <Edit3 size={18} />
                      </button>
                      <button
                        onClick={() => confirmDeleteDoctor(d._id)}
                        className="p-2 text-[var(--text-tertiary)] hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-colors"
                      >
                        <Trash2 size={18} />
                      </button>
                    </td>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 w-screen h-screen bg-slate-900/50 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
          <div className="bg-[var(--card-bg)] w-full max-w-lg rounded-3xl shadow-2xl border border-[var(--border-color)] flex flex-col overflow-hidden max-h-[90vh]">
            ...
            <form
              ...
              className="p-6 space-y-4 overflow-y-auto flex-1 scrollbar-thin"
            >
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-[var(--border-color)] rounded-xl text-sm font-medium focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none text-[var(--text-primary)] bg-[var(--card-bg)]"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold text-[var(--text-tertiary)] uppercase mb-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-[var(--border-color)] rounded-xl text-sm font-bold text-[var(--text-primary)] focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none bg-[var(--card-bg)]"
                  >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="w-full px-4 py-2 bg-[var(--bg-tertiary)] border border-[var(--border-color)] text-[var(--text-secondary)] font-bold rounded-xl text-sm leading-relaxed">
                    {editingDoctor
