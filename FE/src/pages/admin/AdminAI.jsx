  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-[var(--card-bg)] p-6 rounded-3xl border border-[var(--border-color)] shadow-sm">
        ...
        <button
          type="button"
          className="px-5 py-2.5 bg-indigo-600 text-white font-bold rounded-xl flex items-center gap-2 hover:bg-indigo-700 shadow-lg shadow-indigo-600/20"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 dark:bg-slate-950 rounded-3xl p-6 font-mono text-xs text-green-400 overflow-hidden shadow-lg border border-slate-800 dark:border-slate-800">
