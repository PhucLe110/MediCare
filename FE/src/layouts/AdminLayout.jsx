        ...
        <header className="h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-8 shrink-0 z-10 sticky top-0">
          ...
          <div className="flex items-center gap-5">
            <div className="text-sm text-slate-500 font-medium">
              {t.serverStatus}:{" "}
              <span className="text-emerald-500 font-bold ml-1 flex items-center inline-flex gap-1.5">
            ...
            <Link
              to="/dashboard"
              className="text-sm font-bold text-indigo-600 hover:text-indigo-800 flex items-center gap-1.5 bg-indigo-50 px-3 py-1.5 rounded-lg border border-indigo-100 transition-colors"
            >
